...
export const TAB_SPECS: TabSpec[] = [
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "Household credit growth, year over year", series: ["ca_mortgage_credit", "ca_consumer_credit", "us_re_loans", "us_consumer_loans"], kind: "line", zeroLine: true,
        note: "Outstanding bank loans. Canada: chartered banks (OSFI A4 return), from mid-2017; U.S.: all commercial banks (real estate loans include commercial property). The January 2019 definition change distorts Canadian mortgage growth during 2019." },
      { title: "Business credit growth, year over year", series: ["ca_business_credit", "us_ci_loans"], kind: "line", zeroLine: true,
        note: "Canada: total business loans by chartered banks. U.S.: commercial and industrial loans. Credit growth usually slows when lending standards tighten, and turns before business investment." },
      { title: "Variable-rate share of new Canadian mortgage lending", series: ["ca_variable_mortgage_share"], kind: "line",
        note: "Variable-rate share of mortgage funds advanced (new loans, renewals and refinancing), 3-month total. Borrowers shift to variable when they expect rate cuts; a higher share also means policy changes reach households faster." },
