...
export const TAB_SPECS: TabSpec[] = [
  {
    ...
    charts: [
      ...
      { title: "U.S. capacity utilization", series: ["us_capacity_util"], kind: "line", refLine: 80,
        note: "Share of industrial capacity in use. The dashed line at 80% is close to the long-run average; sustained readings above it signal cost pressure, falling readings signal slack." },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "U.S. job openings per unemployed person", series: ["us_openings_per_unemployed"], kind: "line", refLine: 1,
        note: "JOLTS openings divided by unemployed persons. Above 1 (dashed) means more vacancies than job seekers, a tight market." },
      ...
      { title: "U.S. initial jobless claims", series: ["us_initial_claims"], kind: "line",
        note: "Monthly average of weekly claims. The most timely layoff signal; a sustained rise usually precedes a rise in unemployment." },
    ],
    answer: (get) => {
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "U.S. core inflation momentum, 3-month annualized", series: ["us_core_pce_3m", "us_core_cpi_3m"], kind: "line", refLine: 2,
        note: "Annualized change over the last three months. Turns before the year-over-year rate, but is noisier." },
  ...
  },
  {
    ...
    charts: [
      ...
      { title: "U.S. building permits", series: ["us_building_permits"], kind: "line",
        note: "Thousands of units, seasonally adjusted annual rate. Housing is among the most rate-sensitive sectors, and permits lead construction activity." },
      { title: "U.S. core capital goods orders, year over year", series: ["us_core_capex_orders"], kind: "line", zeroLine: true,
        note: "Nondefense capital goods excluding aircraft: the standard read on business investment plans." },
      { title: "U.S. consumers' expected inflation, next 12 months", series: ["us_consumer_infl_exp"], kind: "line",
        note: "University of Michigan survey. Rising household expectations make central banks slower to cut." },
    ],
    answer: (get) => {
