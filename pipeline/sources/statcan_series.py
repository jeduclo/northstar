...
SERIES = {  # name: (table, filters, max lag days)
    ...
    "ca_unemployment": ("14100287", {**LFS, "Labour force characteristics": "Unemployment rate"}, 75),
    "ca_participation": ("14100287", {**LFS, "Labour force characteristics": "Participation rate"}, 75),
    "ca_employment": ("14100287", {**LFS, "Labour force characteristics": "Employment"}, 75),
    "ca_ippi_total": ("18100265", {**CA, "Product": "Total, Industrial product price index"}, 75),
    "ca_retail_sales": ("20100056", {**CA, "Industry": "Retail trade", "Adjustments": "Seasonally adjusted", "Sales": "Total retail sales"}, 90),
    ...
    "ca_gdp_quarterly": ("36100104", {**CA, "Prices": "Chained (2017) dollars", "Seasonal adjustment": "Seasonally adjusted at annual rates",
